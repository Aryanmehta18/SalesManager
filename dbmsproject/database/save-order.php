   ...
   foreach($post_data_arr as $pid=>$supplier_qty){
    foreach($supplier_qty as $sid=>$qty){
       $values=[
                ...
                $sql = "INSERT INTO order_product(supplier,product,quantity_ordered,status,batch,created_by,updated_at,created_at) VALUES (:supplier,:product,:quantity_ordered,:status,:batch,:created_by,:updated_at,:created_at)";
